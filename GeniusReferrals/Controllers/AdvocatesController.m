                ...
                completionBlock:(CompletedGetShareLinks) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/accounts/{account_slug}/advocates/{advocate_token}/share-links"];
                ...
                completionBlock:(CompletedPutPaymentMethod) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/accounts/{account_slug}/advocates/{advocate_token}/payment-methods/{advocate_payment_method_id}"];

    //process optional query parameters
    [APIHelper appendUrl: _queryBuilder withTemplateParameters: @{
                    @"account_slug": accountSlug,
                    @"advocate_token": advocateToken,
                    @"advocate_payment_method_id": [NSNumber numberWithInteger: advocatePaymentMethodId]
                }];
    ...
    HttpRequest* _request = [[self clientInstance] putBody: ^(HttpBodyRequest* _request)
    {
        [_request setBody: [[APIHelper jsonSerialize: advocatePaymentMethodForm] dataUsingEncoding:NSUTF8StringEncoding]]; //set request body
        [_request setQueryUrl: _queryUrl]; //set request url        
        [_request setHeaders: _headers]; //set request headers
                ...
                completionBlock:(CompletedPostPaymentMethod) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/accounts/{account_slug}/advocates/{advocate_token}/payment-methods"];
                ...
                completionBlock:(CompletedGetBonusRedemptionMethod) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/utilities/bonuses-redemption-methods/{bonuses_redemption_method_slug}"];
...
- (void) getBonusRedemptionMethodsWithCompletionBlock:(CompletedGetBonusRedemptionMethods) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/utilities/bonuses-redemption-methods"];
...
- (void) getCurrenciesWithCompletionBlock:(CompletedGetCurrencies) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/utilities/currencies"];
                ...
                completionBlock:(CompletedGetCurrency) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/utilities/currencies/{code}"];
