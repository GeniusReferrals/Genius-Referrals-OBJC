...
/**
* Completion block definition for asynchronous call to Post Bonus */
typedef void (^CompletedPostBonus)(BOOL success, HttpContext* context, id response, NSError* error);
...
/**
* Completion block definition for asynchronous call to Get Bonus Checkup */
typedef void (^CompletedGetBonusCheckup)(BOOL success, HttpContext* context, NSData* response, NSError* error);
...
/**
* Completion block definition for asynchronous call to Post Force Bonus */
typedef void (^CompletedPostForceBonus)(BOOL success, HttpContext* context, id response, NSError* error);
...
/**
* Completion block definition for asynchronous call to Get Bonus Trace */
typedef void (^CompletedGetBonusTrace)(BOOL success, HttpContext* context, id response, NSError* error);
...
/**
* Completion block definition for asynchronous call to Get Bonus Traces */
typedef void (^CompletedGetBonusTraces)(BOOL success, HttpContext* context, id response, NSError* error);
