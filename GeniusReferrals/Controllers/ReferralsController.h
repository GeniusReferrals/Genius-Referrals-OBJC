...
/**
* Completion block definition for asynchronous call to Post Referrals */
typedef void (^CompletedPostReferrals)(BOOL success, HttpContext* context, id response, NSError* error);
